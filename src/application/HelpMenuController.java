...
public class HelpMenuController {
    ...
    private void handleViewMenuLink(ActionEvent event) {
    	...
    	TextArea.setText("The View menu has the following options:" + '\n' +  '\n' + "1. Playlist. Selected the Playlist option will open a new window allowing the user to add multiple media files to a playlist." + '\n'  + '\n' + "2. Play Playlist. If there are files within the playlist, this button will play the first file in the playlist."+ '\n'  + '\n' + "3. Play Next. This will play the next file in the playlist."+ '\n'  + '\n' + "4. Fullscreen. Selecting this option will make the JavaCoffee media player fullscreen. Note that this will also stretch the media file currently playing to fill the space." + '\n'  + '\n' + "5. Brightness. Selecting this option will change the brightness of the media file currently open. Selecting this option when no file is open will do???" + '\n' + '\n' + "6. Background color. Selecting the drop down menu will allow the user to select the background color for JavaCoffee media player.");
